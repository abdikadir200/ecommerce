...
<footer className="footer p-10 bg-base-200 text-base-content">
  <aside>
    <h2 className='text-3xl'>Aman</h2>
    <p>Providing amazing health since 2005</p>
  </aside> 
  <nav>
  ...
  <nav>
    ...
    <a className="link link-hover">aman@gmail.com</a>
    <a className="link link-hover">+1 (356) 456-0921</a>
  </nav> 
